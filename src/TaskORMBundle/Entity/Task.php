...
use Planner\TaskORMBundle\Repository\TaskRepository;
...
class Task implements TaskInterface
{
    ...
    public function getTaskStatus(): TaskStatusInterface
    {
